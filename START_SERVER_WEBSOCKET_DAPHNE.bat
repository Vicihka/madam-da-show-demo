@echo off
title Django Server with WebSocket (Mobile Access)
color 0B
echo ========================================
echo   Django Server with WebSocket Support
echo   Mobile Testing Mode (0.0.0.0)
echo ========================================
echo.
...
echo   Find your IP: ipconfig ^| findstr /i "IPv4"
...
python -m daphne -b 0.0.0.0 -p 8000 project.asgi:application
